...
class Youtube_Subs_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget']; // Whatever you want to display before widget like a div, etc
		...
		echo $args['after_widget']; // Whatever you want to display after widget like a closing div, etc
	}
